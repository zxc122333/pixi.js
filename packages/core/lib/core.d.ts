 ...
 */
export declare function autoDetectRenderer(options: IRendererOptionsAuto): Renderer;
 ...
 */
declare function autoDetectResource(source: any, options?: IAutoDetectOptions): Resource;
 ...
 * @readonly
 */
declare const INSTALLED: Array<IResourcePlugin>;
...
export declare class Shader
{
     ...
     */
    static from(vertexSrc?: string, fragmentSrc?: string, uniforms?: {
        [x: string]: any;
    }): Shader;
}
...
export declare class UniformGroup
{
    ...
    update(): void;
    add(name: string, uniforms: {
        [key: string]: any;
    }, _static: boolean): void;
    static from(uniforms: {
        [key: string]: any;
    }, _static: boolean): UniformGroup;
}
